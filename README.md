...
*(Image idea: Side-by-side comparison reducing standard box vs OBB box)*
...
*(Image idea: A diagram showing YOLO detecting the object and ArUco providing the reference frame)*
